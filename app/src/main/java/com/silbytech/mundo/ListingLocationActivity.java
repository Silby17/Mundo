 ...
 ************************************/
public class ListingLocationActivity extends AppCompatActivity implements OnMapReadyCallback {
    public String TAG = "ListingLocationActivity";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.location_input_layout);
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        mMap = googleMap;
        LatLng sydney = new LatLng(32.109333, 34.855499);
